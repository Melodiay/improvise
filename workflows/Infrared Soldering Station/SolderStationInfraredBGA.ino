...
int pwmv = 255; // ШИМ верхнего нагревателя по умолчанию 30% == в ШИМ = 76 дробную часть отбрасываем 76,5
int pwmn = 255; // ШИМ нижнего нагревателя по умолчанию 30% == в ШИМ = 76 дробную часть отбрасываем 76,5
...
float Kp = 0.0;  // ПИД регулирование для расчетов и подстановки в ПИД регулирование
float Ki = 0.0;  // ПИД регулирование для расчетов и подстановки в ПИД регулирование
float Kd = 0.0;  // ПИД регулирование для расчетов и подстановки в ПИД регулирование

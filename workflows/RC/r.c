...
int ShowR()
{
    ...
    Sum = GTK_SPIN_BUTTON(gtk_builder_get_object(bResistors, "spinbutton3"));
    label3 = GTK_LABEL(gtk_builder_get_object(bResistors, label3));
    ...
    area2 = GTK_WIDGET(gtk_builder_get_object(bResistors, "drawingarea2"));

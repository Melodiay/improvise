...
#define verhniy_1 4 // указываем верхний нагреватель порт 4 вывода с ШИМ
...
byte coolvust1 = 0;
byte coolpust2 = 0;
float kpv = 0.0000000000; // ПИД регулирование порпорциональное   значение по умолчанию
float kiv = 0.0000000000; // ПИД регулирование интегральное       значение по умолчанию 
float kdv = 0.0000000000;  // ПИД регулирование дифферинциальное   значение по умолчанию
...
float kpn = 0.0000000000; // ПИД регулирование порпорциональное   значение по умолчанию
float kin = 0.0000000000; // ПИД регулирование интегральное       значение по умолчанию 
float kdn = 0.0000000000;  // ПИД регулирование дифферинциальное   значение по умолчанию

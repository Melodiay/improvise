...
void setup(void) 
{
  ...
  { // первый запуск
    ...
    //delay(10);
    //EEPROM.put(187, pwmv);// Не используется
    //EEPROM.put(192, pwmn);// Не используется 
    //delay(10);
...
//термопрофиль User 2 шаг 0
	EEPROM.put(3860, pwmv);
	EEPROM.put(3865, pwmn);
    //термопрофиль User 2 шаг 1
	EEPROM.put(3870, pwmv);
	EEPROM.put(3875, pwmn);
    //термопрофиль User 2 шаг 2
	EEPROM.put(3880, pwmv);
	EEPROM.put(3885, pwmn);
    //термопрофиль User 2 шаг 3
	EEPROM.put(3890, pwmv);
	EEPROM.put(3895, pwmn);
    //термопрофиль User 2 шаг 4
	EEPROM.put(3900, pwmv);
	EEPROM.put(3905, pwmn);
    //термопрофиль User 2 шаг 5
 	EEPROM.put(3910, pwmv);
	EEPROM.put(3915, pwmn);
    //термопрофиль User 2 шаг 6
	EEPROM.put(3920, pwmv);
	EEPROM.put(3925, pwmn); 
    //термопрофиль User 2 шаг 7
	EEPROM.put(3930, pwmv);
	EEPROM.put(3935, pwmn); 
    //термопрофиль User 2 шаг 8
 	EEPROM.put(3940, pwmv);
	EEPROM.put(3945, pwmn);
    //термопрофиль User 2 шаг 9
	EEPROM.put(3950, pwmv);
	EEPROM.put(3955, pwmn);
    //термопрофиль User 2 шаг 10
	EEPROM.put(3960, pwmv);
	EEPROM.put(3965, pwmn);
	...
	//термопрофиль User 3 шаг 0
	EEPROM.put(3970, pwmv);
	EEPROM.put(3975, pwmn);
    //термопрофиль User 3 шаг 1
	EEPROM.put(3980, pwmv);
	EEPROM.put(3985, pwmn);
    //термопрофиль User 3 шаг 2
	EEPROM.put(3990, pwmv);
	EEPROM.put(3995, pwmn);
    //термопрофиль User 3 шаг 3
	EEPROM.put(4000, pwmv);
	EEPROM.put(4005, pwmn);
    //термопрофиль User 3 шаг 4
	EEPROM.put(4010, pwmv);
	EEPROM.put(4015, pwmn);
    //термопрофиль User 3 шаг 5
 	EEPROM.put(4020, pwmv);
	EEPROM.put(4025, pwmn);
    //термопрофиль User 3 шаг 6
	EEPROM.put(4030, pwmv);
	EEPROM.put(4035, pwmn); 
    //термопрофиль User 3 шаг 7
	EEPROM.put(4040, pwmv);
	EEPROM.put(4045, pwmn); 
    //термопрофиль User 3 шаг 8
 	EEPROM.put(4050, pwmv);
	EEPROM.put(4055, pwmn);
    //термопрофиль User 3 шаг 9
	EEPROM.put(4060, pwmv);
	EEPROM.put(4065, pwmn);
    //термопрофиль User 3 шаг 10
	EEPROM.put(4070, pwmv);
	EEPROM.put(4075, pwmn);
	...
	//термопрофиль User 4 шаг 0
	EEPROM.put(4080, pwmv);
	EEPROM.put(4085, pwmn);
    //термопрофиль User 4 шаг 1
	EEPROM.put(4090, pwmv);
	EEPROM.put(4095, pwmn);
    //термопрофиль User 4 шаг 2
	EEPROM.put(4100, pwmv);
	EEPROM.put(4105, pwmn);
    //термопрофиль User 4 шаг 3
	EEPROM.put(4110, pwmv);
	EEPROM.put(4115, pwmn);
    //термопрофиль User 4 шаг 4
	EEPROM.put(4120, pwmv);
	EEPROM.put(4125, pwmn);
    //термопрофиль User 4 шаг 5
 	EEPROM.put(4130, pwmv);
	EEPROM.put(4135, pwmn);
    //термопрофиль User 4 шаг 6
	EEPROM.put(4140, pwmv);
	EEPROM.put(4145, pwmn); 
    //термопрофиль User 4 шаг 7
	EEPROM.put(4150, pwmv);
	EEPROM.put(4155, pwmn); 
    //термопрофиль User 4 шаг 8
 	EEPROM.put(4160, pwmv);
	EEPROM.put(4165, pwmn);
    //термопрофиль User 4 шаг 9
	EEPROM.put(4170, pwmv);
	EEPROM.put(4175, pwmn);
    //термопрофиль User 4 шаг 10
	EEPROM.put(4180, pwmv);
	EEPROM.put(4185, pwmn);	
	...
	//термопрофиль User 5 шаг 0
	EEPROM.put(4190, pwmv);
	EEPROM.put(4195, pwmn);
    //термопрофиль User 5 шаг 1
	EEPROM.put(4200, pwmv);
	EEPROM.put(4205, pwmn);
    //термопрофиль User 5 шаг 2
	EEPROM.put(4210, pwmv);
	EEPROM.put(4215, pwmn);
    //термопрофиль User 5 шаг 3
	EEPROM.put(4220, pwmv);
	EEPROM.put(4225, pwmn);
    //термопрофиль User 5 шаг 4
	EEPROM.put(4230, pwmv);
	EEPROM.put(4235, pwmn);
    //термопрофиль User 5 шаг 5
 	EEPROM.put(4240, pwmv);
	EEPROM.put(4245, pwmn);
    //термопрофиль User 5 шаг 6
	EEPROM.put(4250, pwmv);
	EEPROM.put(4255, pwmn); 
    //термопрофиль User 5 шаг 7
	EEPROM.put(4260, pwmv);
	EEPROM.put(4265, pwmn); 
    //термопрофиль User 5 шаг 8
 	EEPROM.put(4270, pwmv);
	EEPROM.put(4275, pwmn);
    //термопрофиль User 5 шаг 9
	EEPROM.put(4280, pwmv);
	EEPROM.put(4285, pwmn);
    //термопрофиль User 5 шаг 10
	EEPROM.put(4290, pwmv);
	EEPROM.put(4295, pwmn);	
  ...
  }else if (EEPROM.get(207, termoprofily) == 3)
  {
         ...
         //термопрофиль User 2 шаг 0
          ...
          //термопрофиль User 2 шаг 0
          EEPROM.get(3860, pwmv);
          EEPROM.get(3865, pwmn);
         shag = 0;
         outNumber("termoprofily.shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("pidv.shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("pidn.shag.val", shag);  // Отображение числа в числовом компоненте shag
  ...
  }else if (EEPROM.get(207, termoprofily) == 4)
  {
         ...
         EEPROM.get(1785, temp2);
          ...
          //термопрофиль User 3 шаг 0
          EEPROM.get(3970, pwmv);
          EEPROM.get(3975, pwmn);
         shag = 0;
         outNumber("termoprofily.shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("pidv.shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("pidn.shag.val", shag);  // Отображение числа в числовом компоненте shag
  ...
  }else if (EEPROM.get(207, termoprofily) == 5)
  {
        ...
        //термопрофиль User 4 шаг 0
          ...
          //термопрофиль User 4 шаг 0
          EEPROM.get(4080, pwmv);
          EEPROM.get(4085, pwmn);         
         shag = 0;
         outNumber("termoprofily.shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("pidv.shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("pidn.shag.val", shag);  // Отображение числа в числовом компоненте shag
  ...
  }else if (EEPROM.get(207, termoprofily) == 6)
  {
      //термопрофиль User 5
        ...
        //термопрофиль User 5 шаг 0
          ...
          //термопрофиль User 5 шаг 0
          EEPROM.get(4190, pwmv);
          EEPROM.get(4195, pwmn);
         shag = 0;
         outNumber("termoprofily.shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("pidv.shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("pidn.shag.val", shag);  // Отображение числа в числовом компоненте shag
  ...
  if (incStr.indexOf("b4") >= 0) 
  {
    if (shag < 10)
    {
     ...
     } else if(shag == 1)
     {
      ...
      }else if (termoprofily == 3)
      {
         ...
         delay(10);
            //термопрофиль User 2 шаг 1
          EEPROM.get(3870, pwmv);
          EEPROM.get(3875, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 2";
      ...
      }else if (termoprofily == 4)
      {
        ...
        //shag == 1
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 3 шаг 1
          EEPROM.get(3980, pwmv);
          EEPROM.get(3985, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 3";
      ...
      }else if (termoprofily == 5)
      {
        ...
        //shag == 1
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 4 шаг 1
          EEPROM.get(4090, pwmv);
          EEPROM.get(4095, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 4";
      ...
      }else if (termoprofily == 6)
      {
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 5 шаг 1
          EEPROM.get(4200, pwmv);
          EEPROM.get(4205, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 5";
    ...
    } else if(shag == 2)
    {
        ...
        }else if (termoprofily == 3)
      {
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 2 шаг 2
          EEPROM.get(3880, pwmv);
          EEPROM.get(3885, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 2";
        ...
        }else if (termoprofily == 4)
      {
        //shag == 2 
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 3 шаг 2
          EEPROM.get(3990, pwmv);
          EEPROM.get(3995, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 3";
        ...
        }else if (termoprofily == 5)
      {
        //shag == 2 
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 4 шаг 2
          EEPROM.get(4100, pwmv);
          EEPROM.get(4105, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 4";
        ...
        }else if (termoprofily == 6)
      {
        //shag == 2 
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 5 шаг 2
          EEPROM.get(4210, pwmv);
          EEPROM.get(4215, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 5";
    ...
    } else if(shag == 3)
    {
        ...
        } else if (termoprofily == 3)
      {
        ...
        delay(10);
        //термопрофиль User 2 шаг 3
        EEPROM.get(3890, pwmv);
        EEPROM.get(3895, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 2";
        ...
        }else if (termoprofily == 4)
      {
        ...
        delay(10);
        //термопрофиль User 3 шаг 3
        EEPROM.get(4000, pwmv);
        EEPROM.get(4005, pwmn);  
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 3";
        ...
        }else if (termoprofily == 5)
      {
        ...
        delay(10);
          ...
          delay(10);
          //термопрофиль User 4 шаг 3
          EEPROM.get(4110, pwmv);
          EEPROM.get(4115, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 4";
        ...
        }else if (termoprofily == 6)
      {
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 5 шаг 3
          EEPROM.get(4220, pwmv);
          EEPROM.get(4225, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 5";
    ...
    } else if(shag == 4)
    {
        ...
        }else if (termoprofily == 3)
      {
        ...
        delay(10);
        //термопрофиль User 2 шаг 4
        EEPROM.get(3900, pwmv);
        EEPROM.get(3905, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 2";
        ...
        }else if (termoprofily == 4)
      {
        ...
        delay(10);
          ...
          delay(10);
          //термопрофиль User 3 шаг 4
          EEPROM.get(4010, pwmv);
          EEPROM.get(4015, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 3";
        ...
        }else if (termoprofily == 5)
      {
        ...
        delay(10);
        //термопрофиль User 4 шаг 4
        EEPROM.get(4120, pwmv);
        EEPROM.get(4125, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 4";
        ...
        }else if (termoprofily == 6)
      {
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 5 шаг 4
          EEPROM.get(4230, pwmv);
          EEPROM.get(4235, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 5";
    ...
    } else if(shag == 5)
    {
       ...
       } else if (termoprofily == 3)
      {
          ...
          delay(10);
          //термопрофиль User 2 шаг 5
          EEPROM.get(3910, pwmv);
          EEPROM.get(3915, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 2";
       ...
       } else if (termoprofily == 4)
      {
          ...
          delay(10);
          //термопрофиль User 3 шаг 5
          EEPROM.get(4020, pwmv);
          EEPROM.get(4025, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 3";
       ...
       } else if (termoprofily == 5)
      {
          ...
          delay(10);
          //термопрофиль User 4 шаг 5
          EEPROM.get(4130, pwmv);
          EEPROM.get(4135, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 4";
       ...
       } else if (termoprofily == 6)
      {
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 5 шаг 5
          EEPROM.get(4240, pwmv);
          EEPROM.get(4245, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 5";
    ...
    } else if(shag == 6)
    {
       ...
       } else if (termoprofily == 3)
      {
          ...
          delay(10);
          //термопрофиль User 2 шаг 6
          EEPROM.get(3920, pwmv);
          EEPROM.get(3925, pwmn); 
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 2";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 4)
      {
          ...
          delay(10);
          //термопрофиль User 3 шаг 6
          EEPROM.get(4030, pwmv);
          EEPROM.get(4035, pwmn);
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 3";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 5)
      {
          ...
          delay(10);
          //термопрофиль User 4 шаг 6
          EEPROM.get(4140, pwmv);
          EEPROM.get(4145, pwmn);
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 4";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 6)
      {
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 5 шаг 6
          EEPROM.get(4250, pwmv);
          EEPROM.get(4255, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 5";
    ...
    } else if(shag == 7)
    {
       ...
       } else if (termoprofily == 3)
      {
        ...
        delay(10);
        //термопрофиль User 2 шаг 7
        EEPROM.get(3930, pwmv);
        EEPROM.get(3935, pwmn); 
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 2";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 4)
      {
        ...
        EEPROM.get(2200, kdn);
         delay(10);
          ...
          delay(10);
          //термопрофиль User 3 шаг 7
          EEPROM.get(4040, pwmv);
          EEPROM.get(4045, pwmn); 
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 3";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 5)
      {
        ...
        delay(10);
        //термопрофиль User 4 шаг 7
        EEPROM.get(4150, pwmv);
        EEPROM.get(4155, pwmn);
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 4";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 6)
      {
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 5 шаг 7
          EEPROM.get(4260, pwmv);
          EEPROM.get(4265, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 5";
    ...
    } else if(shag == 8)
    {
       ...
       } else if (termoprofily == 3)
      {
        ...
        delay(10);
        //термопрофиль User 2 шаг 8
        EEPROM.get(3940, pwmv);
        EEPROM.get(3945, pwmn);
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 2";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 4)
      {
        ...
        delay(10);
        //термопрофиль User 3 шаг 8
        EEPROM.get(4050, pwmv);
        EEPROM.get(4055, pwmn);
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 3";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 5)
      {
        ...
        delay(10);
        //термопрофиль User 4 шаг 8
        EEPROM.get(4160, pwmv);
        EEPROM.get(4165, pwmn);
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 4";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 6)
      {
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 5 шаг 8
          EEPROM.get(4270, pwmv);
          EEPROM.get(4275, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 5";
    ...
    } else if(shag == 9)
    {
       ...
       } else if (termoprofily == 3)
      {
        ...
        delay(10);
        //термопрофиль User 2 шаг 9
        EEPROM.get(3950, pwmv);
        EEPROM.get(3955, pwmn);
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 2";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 4)
      {
        ...
        delay(10);
        //термопрофиль User 3 шаг 9
        EEPROM.get(4060, pwmv);
        EEPROM.get(4065, pwmn);
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 3";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       }else if (termoprofily == 5)
      {
        ...
        delay(10);
        //термопрофиль User 4 шаг 9
        EEPROM.get(4170, pwmv);
        EEPROM.get(4175, pwmn);
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 4";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 6)
      {
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 5 шаг 9
          EEPROM.get(4280, pwmv);
          EEPROM.get(4285, pwmn);
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 5";
    ...
    } else if(shag == 10)
    {
       ...
       } else if (termoprofily == 3)
      {
        ...
        delay(10);
        //термопрофиль User 2 шаг 10
        EEPROM.get(3960, pwmv);
        EEPROM.get(3965, pwmn);
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 2";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 4)
      {
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 3 шаг 10
          EEPROM.get(4070, pwmv);
          EEPROM.get(4075, pwmn);
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 3";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 5)
      {
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 4 шаг 10
          EEPROM.get(4180, pwmv);
          EEPROM.get(4185, pwmn);
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 4";
         String t13= "\"" + String(profily) + "\"";  // Отображение 
       ...
       } else if (termoprofily == 6)
        {
         ...
         delay(10);
          ...
          delay(10);
          //термопрофиль User 5 шаг 10
          EEPROM.get(4290, pwmv);
          EEPROM.get(4295, pwmn);	
         //sec=80;
         outNumber("shag.val", shag);  // Отображение числа в числовом компоненте shag
         outNumber("sec.val", sec);  // Отображение числа в числовом компоненте sec
         profily="User 5";

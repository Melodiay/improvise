...
void loop(void) {
  ...
  **/
  ...
  if (temp==1){
     if (!(nexSerial.available())){   // если не принимаем и не передаем даные, то считываем температуры temp1 и temp2, в противном случае игнорируем temp1 и temp2
...
/**
// с детектором ноля, закоментируйте код выше, а этот разкоментируйте
// Пид регулирование нижний нагреватель
void nigniye(){
  // (вход, установка, п, и, д, период в секундах, мин.выход, макс. выход)
